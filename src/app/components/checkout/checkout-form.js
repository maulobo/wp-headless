...
const CheckoutForm = ({ countriesData }) => {
  ...
  const handleFormSubmit = async (event) => {
    ...
    // This is for payment mode Mercado Pago, and handle the payment !!

    if ("mercadoPago" === input.paymentMethod) {
      const createOrdearData = await handleMercadoPago(
        input,
        cart?.cartItems,
        setRequestError,
        setCart,
    ...
    if ("bankTransfer" === input.paymentMethod) {
