        ...
        <div className="woo-next-cart-table-row grid lg:grid-cols-3 gap-4">
          ...
          <div className="woo-next-cart-total-container lg:col-span-1 p-5 pt-0">
            ...
            <div className="flex justify-between">
              ...
              {/*Checkout*/}
              <Link href="/checkout">
                <button className="text-red duration-500 bg-brand-orange hover:bg-brand-royal-blue focus:ring-4 focus:text-white font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:focus:ring-yellow-900">
